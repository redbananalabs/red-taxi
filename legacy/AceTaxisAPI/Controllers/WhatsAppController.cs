...
namespace AceTaxisAPI.Controllers
{
    ...
    public class WhatsAppController : TwilioController
    {
        ...
        public WhatsAppController(AceDbContext db, 
                ...
                try
                {
                    ...
                    if (request.Body == "ACCEPT")
                    {
                        ...
                        if (allocated != null && allocated == id)
                        {
                            ...
                            p.SetProperty(u => u.Status, AceTaxis.Domain.BookingStatus.AcceptedJob));
                    ...
                    {
                        await _db.Bookings.Where(o => o.Id == jobid).ExecuteUpdateAsync(p =>
                        p.SetProperty(u => u.Status, AceTaxis.Domain.BookingStatus.RejectedJob)
