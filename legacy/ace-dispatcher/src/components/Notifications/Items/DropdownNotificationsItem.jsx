        ...
        <div className="flex gap-3 mt-2">
          ...
          {documentURL && (
            <a
              ...
              className="rounded-md text-sm text-white bg-blue-500 hover:shadow-lg font-semibold w-auto justify-center p-2"
          ...
          {event === 1 &&
            (message.includes("created a new web booking request") ||
              ...
              <Link
                ...
                onClick={() => markAsRead(id)}
              >
                <button className="rounded-md text-sm text-white bg-blue-500 hover:shadow-lg font-semibold w-auto justify-center p-2">
                  View Bookings
                </button>
              </Link>
            )}
          ...
          {status === 0 && (
            <button
              onClick={() => markAsRead(id)}
              className="bg-gray-100 hover:shadow-lg font-semibold text-sm w-auto justify-center rounded-md p-2 border-gray-200 border text-gray-600"
            >
              Mark as read
            </button>
          )}
