...
namespace RedTaxi.API.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public AccountsController(AccountsService service, RedTaxiDbContext db,UserManager<AppUser> userManager, GeoZoneService geoService)
        {
            _service = service;
            _db = db;
        ...
        //[HttpGet]
        //[Route("ClearInvoice")]
        //public async Task<IActionResult> ClearInvoice(string invoiceno)
        //{
        //    var invno = Convert.ToInt32(invoiceno);

        //    await _db.Bookings.Where(o => o.InvoiceNumber == invno)
        //        .ExecuteUpdateAsync(o => o.SetProperty(u => u.InvoiceNumber, (int?)null));

        //    await _db.AccountInvoices.Where(o => o.InvoiceNumber == invno).ExecuteDeleteAsync();
